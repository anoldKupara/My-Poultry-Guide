...
class FeedsTest < ApplicationSystemTestCase
  ...
  test "creating a Feed" do
    ...
    fill_in "Currency", with: @feed.currency_id
    fill_in "Description", with: @feed.description
    fill_in "Name", with: @feed.name
    fill_in "Price", with: @feed.price
    fill_in "Purpose", with: @feed.purpose
    fill_in "Quantity", with: @feed.quantity
    fill_in "Supplier", with: @feed.supplier
